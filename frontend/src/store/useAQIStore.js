...
const ALERTS = [
  {
    ...
    message:
      "AQI exceeded 400 — Hazardous levels detected. Immediate action required.",
    minsAgo: 8,
  },
  {
    id: 2,
    ...
    ward: "Loni",
    message:
      "PM2.5 spike — possible large-scale crop/biomass burning detected via satellite.",
    minsAgo: 22,
  },
  {
    id: 3,
    severity: "high",
    ward: "Sahibabad Indl",
    message: "Industrial NO2 surge — emissions at 2.1× permissible threshold.",
    minsAgo: 45,
  },
  {
    id: 4,
    severity: "high",
    ward: "Pasaunda",
    message: "Rising AQI trend — ML forecast predicts 380+ in next 6 hours.",
    minsAgo: 67,
  },
  {
    id: 5,
    severity: "medium",
    ward: "GT Road Corridor",
    message: "Morning rush-hour vehicle pollution spike detected.",
    minsAgo: 112,
  },
  {
    id: 6,
    ...
    ward: "Govindpuram",
    message:
      "Construction dust elevated — 3 new active sites without barriers.",
    minsAgo: 145,
  },
  {
    id: 7,
    ...
    ward: "Indirapuram",
    message:
      "AQI improving — wind direction shift aiding pollutant dispersion.",
    minsAgo: 180,
  },
];
...
const CITIZEN_REPORTS = [
  {
    ...
    type: "Crop Burning",
    description:
      "Large fire near agricultural fields on Loni bypass road, black smoke visible.",
    minsAgo: 120,
    status: "verified",
  },
  {
    ...
    description:
      "Continuous thick black smoke from brick kiln near NH-9 overpass since morning.",
    minsAgo: 240,
    status: "verified",
  },
  {
    ...
    ward: "Sahibabad Indl",
    type: "Industrial Smoke",
    description: "Grey smoke emission from large factory near GIP Mall area.",
    minsAgo: 360,
    status: "pending",
  },
  {
    ...
    description: "Municipal waste pile burning near the weekly market area.",
    minsAgo: 480,
    status: "pending",
  },
  {
    ...
    description:
      "Uncovered construction site on main road without water sprinklers.",
    minsAgo: 600,
    status: "resolved",
  },
];
...
const useAQIStore = create((set, get) => ({
  ...
  submitReport: (report) =>
    set((state) => ({
      citizenReports: [
        { ...report, id: Date.now(), minsAgo: 0, status: "pending" },
        ...state.citizenReports,
      ],
    })),
  getWardById: (id) => get().wards.find((w) => w.id === Number(id)),
  getWardForecast: (id) => {
    const w = get().wards.find((w) => w.id === Number(id));
    return w ? generateForecast(w.aqi, w.id * 3) : [];
  },
  getWardHistory: (id) => {
    const w = get().wards.find((w) => w.id === Number(id));
    return w ? generateHistory(w.aqi, w.id * 7) : [];
  },
}));
